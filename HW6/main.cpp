/*
	HW3 Space Invaders w/ Sound, By: Nathan Ly
...
void Setup() {
	...
	music = Mix_LoadMUS("SpaceAdventure.mp3");
	Mix_PlayMusic(music, -1);
	
	enemyDeath = Mix_LoadWAV("invaderkilled.wav");
	enemyShoot = Mix_LoadWAV("shoot.wav");
	playerDeath = Mix_LoadWAV("explosion.wav");
	playerShoot = Mix_LoadWAV("laser.wav");
}
